...
*/
  ...
  class cop {
    ...
    function __construct() {
      ...
      $this->sort_order = defined('MODULE_PAYMENT_COP_SORT_ORDER') ? MODULE_PAYMENT_COP_SORT_ORDER : 0;
      $this->enabled = defined('MODULE_PAYMENT_COP_STATUS') && (MODULE_PAYMENT_COP_STATUS == 'True') ? true : false;
      $this->order_status = defined('MODULE_PAYMENT_COP_ORDER_STATUS_ID') && ((int)MODULE_PAYMENT_COP_ORDER_STATUS_ID > 0) ? (int)MODULE_PAYMENT_COP_ORDER_STATUS_ID : 0;
...
// disable the module if the order only contains virtual products
 ...
 if ($order->content_type == 'virtual') {
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort order of display.', 'MODULE_PAYMENT_COP_SORT_ORDER', '0', 'Sort order of display. Lowest is displayed first.', '6', '0', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Set Order Status', 'MODULE_PAYMENT_COP_ORDER_STATUS_ID', '0', 'Set the status of orders made with this payment module to this value', '6', '0', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
   }
