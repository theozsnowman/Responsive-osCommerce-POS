...
*/
  ...
  define('MODULE_CONTENT_FOOTER_INFORMATION_SIZE', 'Størrelse');
  define('MODULE_CONTENT_FOOTER_INFORMATION_TOPPING', 'Fyld');
  define('MODULE_CONTENT_FOOTER_INFORMATION_SHIPPING', 'Levering/Afhenting');
  define('MODULE_CONTENT_FOOTER_INFORMATION_CONDITIONS', 'Betingelser');
